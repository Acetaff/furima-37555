...
ActiveRecord::Schema.define(version: 2022_03_03_020809) do
  ...
  create_table "product_purchases", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["item_id"], name: "index_product_purchases_on_item_id"
  ...
  create_table "purchasers", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["product_purchase_id"], name: "index_purchasers_on_product_purchase_id"
  end
  ...
  add_foreign_key "product_purchases", "items"
  add_foreign_key "product_purchases", "users"
  add_foreign_key "purchasers", "product_purchases"
end
